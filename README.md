...
<script src="https://cdn.jsdelivr.net/gh/Swipe-Up-Agency/motionkit@v1.4.3/dist/motion-kit.min.js"></script>
```
...
- `/motionkit@v1.4.3/` — repo name + release tag (immutable once tagged)
- `/dist/motion-kit.min.js` — the committed bundle artifact

Pin to `@v1.4.3` on live client sites. The tag never changes, so clients never get surprise updates.
