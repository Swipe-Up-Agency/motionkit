...
Replace `<your-handle>` with the GitHub account / org that hosts the MotionKit repo. jsDelivr serves straight from the tagged Git release — no npm publish needed.
